...
NAME = libft.a
SRCS = ft_atoi.c ft_bzero.c ft_count_delimited_words.c ft_dstrlen.c \
...
HEADER = libft.h
O_FILES = ft_atoi.o ft_bzero.o ft_count_delimited_words.o ft_dstrlen.o \
ft_intlen.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o \
...
ft_fill_array.o ft_free_array.o
